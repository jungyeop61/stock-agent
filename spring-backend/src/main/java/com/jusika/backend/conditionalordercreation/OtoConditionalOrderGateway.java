...
interface OtoConditionalOrderGateway {
	...
	/** 실행 기록을 만들기 전에 계좌별 일일 누적 OTO 한도를 사전 검사합니다. */
	...
	/** 실제 증권사 호출 직전에 OTO 위험을 일일 누적 한도에 멱등하게 예약합니다. */
