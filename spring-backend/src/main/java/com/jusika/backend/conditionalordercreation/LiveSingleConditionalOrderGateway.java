...
/**
 * SINGLE 조건 주문의 실제 토스 클라이언트 연결 위치입니다.
...
class LiveSingleConditionalOrderGateway implements SingleConditionalOrderGateway {
	...
	/** 토스 호출 전에 SINGLE을 더할 활성 주문 여유를 다시 검사합니다. */
	@Override
	...
	/** 내부 실행 상태 생성 전에 계좌별 일일 누적 SINGLE 위험을 사전 검사합니다. */
	@Override
	...
	/** 토스 호출 직전에 SINGLE 위험을 일일 누적값에 멱등하게 예약합니다. */
	@Override
