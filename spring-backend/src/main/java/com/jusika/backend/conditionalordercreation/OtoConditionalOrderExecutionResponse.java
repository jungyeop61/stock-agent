...
/** 승인된 OTO 조건 주문의 모의 또는 향후 실제 실행 상태를 표현합니다. */
public record OtoConditionalOrderExecutionResponse(
		String executionId,
		String previewId,
	...
	public String toString() {
		return "OtoConditionalOrderExecutionResponse[executionId=***, previewId=***"
