...
/** OTO 조건 주문 미리보기 행의 승인·만료·사용 상태를 조건부로 변경합니다. */
interface OtoConditionalOrderPreviewJpaRepository
		extends JpaRepository<OtoConditionalOrderPreviewEntity, String> {

	/** 유효시간 안의 승인 대기 OTO 미리보기만 승인합니다. */
	@Modifying(clearAutomatically = true, flushAutomatically = true)
	@Query("""
			update OtoConditionalOrderPreviewEntity preview
	...
	/** 유효시간이 지난 승인 대기 OTO 미리보기만 만료 처리합니다. */
	@Modifying(clearAutomatically = true, flushAutomatically = true)
	@Query("""
			update OtoConditionalOrderPreviewEntity preview
	...
	/** 승인된 OTO 미리보기만 실행에 사용된 상태로 변경합니다. */
	@Modifying(clearAutomatically = true, flushAutomatically = true)
	@Query("""
			update OtoConditionalOrderPreviewEntity preview
